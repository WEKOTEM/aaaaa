...
return '📛*¦ * ٺــڼۨــبــٻۧــہ シ  \n🕹*¦* الصور بالتقييد مفتوح مسبقا \nᵛᶤᶰᵒᵇᵒᵗ'
else 
redis:del(boss..':tqeed_photo:'..msg.to.id)
return '📛*¦ * ٺــڼۨــبــٻۧــہ シ  \n🕹*¦*  تم فتح الصوره بالتقييد \nᵛᶤᶰᵒᵇᵒᵗ'
end
end
