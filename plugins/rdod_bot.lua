...
if we_sudo(msg) then
local text = '👋🏻¦ آهلاً عزيزي آلمـطـور 👨‍🔧\n👨‍💻¦ آنتهہ‌‏ آلمـطـور آلآسـآسـي هنآ 🛠\n...\n\n🃏¦ تسـتطـيع‌‏ آلتحگم بگل آلآوآمـر آلمـوجودهہ‌‏ داخل الكيبورد \n👨‍💻¦ فقط آضـغط ع آلآمـر آلذي تريد تنفيذهہ‌‏'
...
local text = [[👋🏻¦ مـرحبآ صديقي آنآ بوت حمايهہ‌‏
📟¦ يمكنني حمايهہ‌‏ مجموعتك 
📛¦ مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
👷🏽¦ ارفعني كمشرف في المجموعهہ‌‏
📝¦ ومن بعدها ارسل كلمة تفعيل 
👨‍💻¦ حتى يتم تفعيل البوت في المجموعهہ‌‏
]]
...
elseif r== "🙊"  then return  "ها خجلت/ي 🙊 😍"
elseif r== "😢"  then return  "ليش تبجي 😢"
elseif r== "😭"  then return  "منو وياك 😭😭"
elseif r== "منور"  then return  " نورك السابق"
elseif r== "😒" and not is_sudo then return  "شبيك-ج  🤔"
elseif r== "مح"  then return  "محح فديتك🙈❤"
elseif r== "شكرا" or r== "ثكرا" then return  "{ •• الـشكر لله حبي •• }"
elseif r== "انته وين"  then return  "بالــبــ🏠ــيــت"
elseif r== "😍"  then return  " I love you❤️😍"
elseif r== "اكرهك"  then return  "عله اساس انت شلونك 😾🖖🏿🕷"
elseif r== "اريد اكبل"  then return  "خخ اني هم اريد اكبل قابل ربي وحد😹🙌️"
elseif r== "ضوجه"  then return  "اي والله ملينه نفس الشي يوميه اف ضوجه🙊😋"
...
elseif r== "طفي السبلت"  then return  "هوه وينه السبلت ميتين حر اوف 🌚🍃"
elseif r== "شغل السبلت"  then return  "تم تشغيل السبلت / لاتكيف ماكو سبلت  🌚🍃"
elseif r== "حفلش"  then return  "افلش راسك 🤓"
elseif r=="نايمين" then return  "موجودين بس الاغلبيه كلها تراسل ع خاص😐🍃'"
elseif r=="اكو احد" then return  "يي عيني انـي موجـود🌝🌿"
elseif r=="شكو" then return  "عله حطت ايدك . سلامتك ماكو شي🌝"
...
elseif r== "جوعان"  then return  "شنو فاتحين مطعم 😐😂"
elseif r== "تعال خاص" or r== "خاصك" or r=="شوف الخاص" or r=="شوف خاص" then return  "اي شعدكم اسرار😉"
...
elseif r== BOT_NAME and r2=="شلونك" then return "الحمدلله بخير اذا انت بخير الحمدلله على الله ماشيه وياها وياها انت  شلونك شخبارك اوضاعك مرتاح ان شاء الله😹🌚"
elseif r== "يومه فدوه"  then return  "فدؤه الج حياتي 😍😙"
elseif r== "افلش"  then return  "باند عام من 30 بوت 😉"
elseif r== "احبج"  then return  "احبج واليحب بلوة وين الله وقسمتي تروح يم عيونج الحلوه "
...
elseif r== "😡"  then  return  "ابرد شكد حماوه 🚒"  
...
elseif r== "😳" or r== "😳😳" or r== "😳😳😳" then return  "شبيك مطلع عيونك ما شايف😹🕷"
elseif r== "صدك"  then return  "شنو مجذب عليك قبل 🌚"
...
elseif r== "حلو"  then return  "حلات عيونك  🌚❤️"
...
elseif r== "المعزوفه" or r=="المعزوفة" or r=="معزوفه" then return  "شكالولك علينه فاتحين ديسكووو👌"
elseif r== "موجود" then return  "تفضل عزيزي 🌝🌸"
elseif r== "اكلك" then return  ".كول عمري 😚🌿"
...
else return   "هاي اخلاقك ليش هاي الالفاظ السزز😏"
end end end  end
return {
patterns = {
"^("..BOT_NAME.." اتفل)(.*)$", 
